...
- **s1 曲沃代翼** → `ep:jin-decline-s1`：throughline=`thesis:shifu-modabizhe`（师服『末大必折』预言，locator.quote 已补宗法层级前件）；counterpoint=`thesis:zhengbo-ke-duan`（郑伯克段于鄢，同题异国结构对照，OP-D-062；`thesis:shimo-changbian` 否决维持 OP-D-057 不变）；**终态拍序（弧灌注后，OP-D-064，`arc/events/s1-quwo.json`）**：封桓叔+师服宗法公理(`ev:quwo-feng-huanshu`，前745，`…:0205`)→庄伯弑孝侯立鄂侯(`ev:zhuangbo-shi-xiaohou`，前725，`…:0207`；鄂侯与孝侯血缘弟/子真冲突见`cf:egou-di-vs-zi`)→庄伯累次伐翼/晋人历次拥立(`ev:zhuangbo-lei-fa-yi`，前718起，`…:0083/:0086/:0097`；内部排序未逐年互证，如实注记)→**武公伐翼虏哀侯**(`ev:quwo-wugong-mie-yi`，前709，`…:0217`；★题旨/顺序本轮更正——原稿"灭翼代晋"终局题旨误置，实指虏哀侯，移至此位)→武公诱杀小子侯(`ev:wugong-you-sha-xiaozihou`，前705，`…:0262`)→曲沃灭翼/桓王命缗立(`ev:huanwang-ming-min`，前704，`…:0267`+`…:0270`)→**武公灭缗受命列诸侯**(`ev:quwo-mie-min-liehou`，前678，新立，承接原 G1 account `ac:shiji-wugong-huilu-mingzhu`史记`:0020`；册命范围与左传`:0500`"一军"分歧见`cf:cebming-fanwei`)；证据链逐字白文 span；无 place 冲突。终裁见 `ADJUDICATION-s1-supplement.md`（2026-07-24，4 事件转正）+ `arc/events/s1-quwo.json`（同日，弧灌注：7 member 事件 JSON 化 + 2 正式 cf + identity_pipeline.py 复核）。
