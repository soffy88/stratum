...
| ~~DEBT-3~~ | **MINERU-AII-INTEGRATION-SPEC-001**（解析） | **W-H1 灌注前（硬需）** | U5 | ✅ **已关闭** 2026-07-22：verbatim 入仓 commit `c39d987`（v0.1-r1）+ conformance/D1–D5 处置 follow-up；见该 spec 附录 A |
| DEBT-4 | **AELLA-KU-EXTRACTOR-EVAL-001**（抽取评测） | 抽取器评测启动前 | U6 | — |
